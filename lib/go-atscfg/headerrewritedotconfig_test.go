...
func TestMakeHeaderRewriteDotConfig(t *testing.T) {
	...
	cfg, err := MakeHeaderRewriteDotConfig(fileName, dses, dss, server, servers, cgs, serverParams, serverCaps, dsRequiredCaps, hdr)
...
func TestMakeHeaderRewriteMidDotConfigNoMaxConns(t *testing.T) {
	...
	cfg, err := MakeHeaderRewriteDotConfig(fileName, dses, dss, mid0, servers, cgs, serverParams, serverCaps, dsRequiredCaps, hdr)
	if err != nil {
		t.Error(err)
	}
